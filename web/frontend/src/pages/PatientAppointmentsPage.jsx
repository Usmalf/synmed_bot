...
export default function PatientAppointmentsPage() {
  ...
  const shouldShowBookingStatus = bookingState.status !== "idle" && Boolean(bookingState.message);
  const shouldShowPaymentStatus = paymentState.status !== "idle" && Boolean(paymentState.message);
  ...
  return (
    <div className="patient-account-grid">
      ...
      >
        ...
        <div className="payment-code-panel appointment-payment-code-panel">
      ...
      {showPaymentCard ? (
      <SectionCard title="Appointment Payment">
