...
export async function sendConsultationAttachment(reference, file) {
  const response = await fetch(`${API_BASE_URL}/consultations/attachment`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function startConsultationCall(payload) {
  const response = await fetch(`${API_BASE_URL}/consultations/call/start`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function acceptConsultationCall(payload) {
  const response = await fetch(`${API_BASE_URL}/consultations/call/accept`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function rejectConsultationCall(reference) {
  const response = await fetch(`${API_BASE_URL}/consultations/call/reject`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function endConsultationCall(reference) {
  const response = await fetch(`${API_BASE_URL}/consultations/call/end`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function sendConsultationCallCandidate(payload) {
  const response = await fetch(`${API_BASE_URL}/consultations/call/candidate`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
